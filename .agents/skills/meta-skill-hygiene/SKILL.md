...
Use this skill to keep every skill asset in sync: `SKILL.md`, `manifest.json`, `agents/openai.yaml`, the Claude and OpenCode wrappers, and the registry sections in `AGENTS.md`, `CLAUDE.md`, and `opencode.md`.
...
3. Run `bun run skills:sync` to regenerate the registries and Claude/OpenCode wrappers.
...
- **NEVER** treat either compatibility wrapper or generated registry sections as the source of truth.
...
- [ ] No drift between manifest, Claude/OpenCode wrappers, and registry
