...
const (
	...
	AuditActionMCPCredentialRotated    AuditAction = "mcp_connection.credential_rotated"
	AuditActionMCPCredentialRevoked    AuditAction = "mcp_connection.credential_revoked"
	AuditActionMCPHealthDiagnosed      AuditAction = "mcp_connection.health_diagnosed"
	AuditActionMCPHealthReset          AuditAction = "mcp_connection.health_reset"
	AuditActionMCPOAuthStarted         AuditAction = "mcp_connection.oauth_started"
	AuditActionMCPOAuthConnected       AuditAction = "mcp_connection.oauth_connected"
	AuditActionMCPOAuthDisconnected    AuditAction = "mcp_connection.oauth_disconnected"
	AuditActionMCPGatewayInvocation    AuditAction = "mcp_gateway.invocation"
